            ...
            <div className="container">
                ...
                <div className="nav">
                    ...
                    <button className={this.state.Index === 2 ? 'active' : ''} onClick={() => this.goPage(2)}>
                        ...
                        <span className="left-command"><i class="fa-solid fa-feather" style={{ color: '#000000' }}></i>&nbsp;</span>
                    </button>
                    <button className={this.state.Index === 3 ? 'active' : ''} onClick={() => this.goPage(3)}>
                        <span>~/.Skills</span>
                        <span className="left-command"><i class="fa-solid fa-user-shield" style={{ color: '#000000' }}></i>&nbsp;</span>
                    </button>
                    <button className={this.state.Index === 4 ? 'active' : ''} onClick={() => this.goPage(4)}>
                        <span>~/.Project</span>
                        <span className="left-command"><i class="fa-solid fa-building-shield" style={{ color: '#000000' }}></i>&nbsp;</span>
                    </button>
